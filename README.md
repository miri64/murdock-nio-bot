...
The majority of the code is kept inside of the `murdock_nio_bot` folder, which
...
To run the bot, the `murdock-nio-bot` script in the root of the codebase is
