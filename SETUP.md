...
You'll notice that "murdock-nio-bot" is scattered throughout the codebase. When
it comes time to modifying the code for your own purposes, you are expected to
replace every instance of "murdock-nio-bot" and its variances with your own
project's name.
...
```
murdock-nio-bot other-config.yaml
```
