...
version = exec_file(("murdock_nio_bot", "__init__.py"))["__version__"]
long_description = read_file(("README.md",))


setup(
    name="murdock-nio-bot",
    version=version,
    ...
    # Allow the user to run the bot with `murdock-nio-bot ...`
    scripts=["murdock-nio-bot"],
)
